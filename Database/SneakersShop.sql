...
/****** Object:  Database [SneakersDb]    Script Date: 5/15/2024 12:51:32 AM ******/
CREATE DATABASE [SneakersDb]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'SneakersDb', FILENAME = N'G:\AIUB\7th Semester\OOP2\Sneaky Sneakers\Database\SneakersDb.mdf' , SIZE = 8192KB , MAXSIZE = UNLIMITED, FILEGROWTH = 1024KB )
 LOG ON 
( NAME = N'SneakersDb_log', FILENAME = N'G:\AIUB\7th Semester\OOP2\Sneaky Sneakers\Database\SneakersDb_log.ldf' , SIZE = 8192KB , MAXSIZE = 2048GB , FILEGROWTH = 10%)
...
ALTER DATABASE [SneakersDb] SET AUTO_CLOSE ON 
GO
...
ALTER DATABASE [SneakersDb] SET QUERY_STORE = ON
GO

ALTER DATABASE [SneakersDb] SET QUERY_STORE (OPERATION_MODE = READ_WRITE, CLEANUP_POLICY = (STALE_QUERY_THRESHOLD_DAYS = 30), DATA_FLUSH_INTERVAL_SECONDS = 900, INTERVAL_LENGTH_MINUTES = 60, MAX_STORAGE_SIZE_MB = 1000, QUERY_CAPTURE_MODE = AUTO, SIZE_BASED_CLEANUP_MODE = AUTO, MAX_PLANS_PER_QUERY = 200, WAIT_STATS_CAPTURE_MODE = ON)
GO
